...
def upgrade() -> None:
    ...
    op.drop_index('idx_associates_id', table_name='associates_credential')
    op.drop_table('associates_credential')
    op.drop_index('associates_email', table_name='associate')
    op.drop_table('associate')
    
    # Modify the columns to be nullable in the customer_business table
    op.alter_column('customer_business', 'tax_id', nullable=True)
    op.alter_column('customer_business', 'license', nullable=True)
    op.alter_column('customer_business', 'company_name', nullable=True)
    op.alter_column('customer_business', 'designation', nullable=True)
