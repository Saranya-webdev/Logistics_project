...
def get_bookings_by_agent_service(db, agent_email, booking_id: Optional[int] = None):
    """
    Retrieves all bookings placed by a specific agent and formats them.
    """
    try:
        bookings = get_bookings_by_agent_crud(db, agent_email, booking_id)
            ...
            "bookings": [
                {
                    ...
                    "est_delivery_date": booking.est_delivery_date.strftime("%Y-%m-%d"),
...
def update_agent_service(db: Session, agent_data: dict) -> dict:
    ...
    try:
        ...
        return {
            ...
            "verification_status": updated_agent.verification_status,  
